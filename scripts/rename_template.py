...
It renames all the occurrences of CRC_B01 (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the CRC_B01 folder
        os.rename(
            os.path.join(root_dir_path, "exts", "CRC_B01", "CRC_B01"),
            os.path.join(root_dir_path, "exts", "CRC_B01", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "CRC_B01"), os.path.join(root_dir_path, "exts", new_name))
